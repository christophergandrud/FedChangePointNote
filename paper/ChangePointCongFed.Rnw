...
<<ParentGlobalOpts, include=FALSE>>=
    ...
    # Load packages
    Pkgs <- c("dplyr", "repmis", "ecp", "gridExtra", "ggplot2", "reshape2")
    ...
    # Load testimony and economic data
...
<<ScrutinyHouseFedCP, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE>>=
...
<<ScrutinyBills, echo=FALSE, message=FALSE, warning=FALSE, out.width='0.8\\linewidth', fig.height=5, cache=TRUE>>=
# Clean bills data
