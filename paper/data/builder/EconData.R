...
# Christopher Gandrud
# 31 July 2013, updated 21 July 2013
##############
...
Symbols <- c("CPIAUCNS", "PCEPI", "INTDSRUSM193N", "DFF", "FEDFUNDS", "GDPDEF",
             "GDPC96", "U6RATE", "SPCS10RSA")
...
write.csv(CombinedEconSlim, file = "components/FREDEconData.csv", row.names = FALSE)
...
cat("#Variable Label and Descriptions For Economic Data", Table,
    file = "components/EconDataDescription.md")
